import type { ConnInfo, ServeInit } from "std/http/server.ts";
import type {
  Comment,
  Element,
  TextChunk,
} from "https://deno.land/x/lol_html@0.0.4/types.d.ts";
import type { UserConfig } from "@unocss/core";
import type { RouteModule } from "aleph/runtime/core/route";
export type {
  Route,
  RouteMatch,
  RouteMeta,
